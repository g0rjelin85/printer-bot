...
📝 *Права доступа:*
Команды /update доступны только авторизованным пользователям."""
...
async def update_repo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if restart.returncode == 0:
            ...
            await update.message.reply_text(f"⚠️ Обновлено до версии *{version_info}*, но ошибка при перезапуске")
